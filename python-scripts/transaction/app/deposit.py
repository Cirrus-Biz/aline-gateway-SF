...
def deposit(member_name, account_dict, member_id):

    print("What Account To Deposit Into?\n")

    account_number_list = []
    for account_type in account_dict:
        account_balance = account_dict[account_type]["account_balance"]
        account_number = account_dict[account_type]["account_number"]
    ...
    while selection:
        try:
            ...
            account_number_selection = input(f"\nEnter The Account Number To Deposit Too: ")
